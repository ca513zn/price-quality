...
export default function BrandsPage() {
  ...
  async function saveEdit(e) {
    ...
    try {
      ...
      setBrands((prev) =>
        prev.map((b) => (b.id === editing.id ? { ...b, name: data.brand.name, slug: data.brand.slug, description: data.brand.description } : b))
      );
      closeEdit();
    } catch (err) {
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            ...
            >
              ...
              {isAdmin && (
                <div className="absolute top-3 right-3 flex gap-1">
                  <button
                    onClick={(e) => { e.preventDefault(); openEdit(brand); }}
                  ...
                  <button
                    onClick={(e) => { e.preventDefault(); deleteBrand(brand); }}
      ...
      {editing && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm" onClick={closeEdit}>
          ...
          >
            <h2 className="text-xl font-semibold text-gray-900 dark:text-gray-100 mb-4">Edit Brand</h2>
